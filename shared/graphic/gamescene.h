...
protected:
    ...
    QGraphicsPixmapItem *m_caseImmarchables[Map::mapWidth] [Map::mapHeight];
    QGraphicsPixmapItem *m_casesDep[Map::mapWidth] [Map::mapHeight];
    QGraphicsPixmapItem *m_casesPortee[Map::mapWidth] [Map::mapHeight];
    QGraphicsPixmapItem *m_imgcasescbt[2] [MAX_PAR_EQUIP];
    QGraphicsPolygonItem *m_grille[Map::mapWidth] [Map::mapHeight];
    ObjectItem *m_imagesObjets [Map::mapWidth] [Map::mapHeight];
    bool m_cases_ateignables [Map::mapWidth] [Map::mapHeight];
