...
{
public:
    OutfitModel(Resource *resource, int bonus_force_min, int bonus_force_max, int bonus_vie_min, int bonus_vie_max, int bonus_points_fight_min, int bonus_points_fight_max);
